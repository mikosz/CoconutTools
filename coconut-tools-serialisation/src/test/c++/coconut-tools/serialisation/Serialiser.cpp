...
BOOST_FIXTURE_TEST_SUITE(SerialisationSerialiserTestSuite, coconut_tools::test_utils::GMockFixture);
...
BOOST_AUTO_TEST_SUITE_END(/* SerialisationSerialiserTestSuite */);
