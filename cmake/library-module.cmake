function(library_module MODULE_NAME TEST_LIBRARIES DEPENDENCY_LIBRARIES)
  ...
  if(SRCS)
    if(NOT ${STATIC_LIB} AND NOT ${SHARED_LIB})
	  message(FATAL_ERROR "At least one of STATIC or SHARED must be specified for library_module")
	endif()
    
    add_library(${MODULE_NAME}_shared SHARED ${SRCS} ${HEADERS})
    add_library(${MODULE_NAME}_static STATIC ${SRCS} ${HEADERS})
    install(TARGETS ${MODULE_NAME}_shared ${MODULE_NAME}_static DESTINATION lib)
    ...
    target_link_libraries(${MODULE_NAME}_shared ${DEPENDENCY_LIBRARIES})
    target_link_libraries(${MODULE_NAME}_static ${DEPENDENCY_LIBRARIES})
